...
-- 資料庫： `petliday`
--
CREATE DATABASE IF NOT EXISTS `petliday` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `petliday`;
...
CREATE TABLE IF NOT EXISTS `index-quiz` (
...
--
-- 資料表新增資料前，先清除舊資料 `index-quiz`
--

TRUNCATE TABLE `index-quiz`;
--
-- 傾印資料表的資料 `index-quiz`
--
...
CREATE TABLE IF NOT EXISTS `member-wishlist` (
  `sid` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 資料表新增資料前，先清除舊資料 `member-wishlist`
--

TRUNCATE TABLE `member-wishlist`;
--
...
--
-- 資料表新增資料前，先清除舊資料 `member_avatar`
--

TRUNCATE TABLE `member_avatar`;
--
...
(14, NULL, 'Hi@gmail.com', '123456%^&', NULL, NULL, 'User', NULL);
...
--
-- 資料表新增資料前，先清除舊資料 `member_pet`
--

TRUNCATE TABLE `member_pet`;
--
-- 傾印資料表的資料 `member_pet`
--
...
CREATE TABLE IF NOT EXISTS `order_list` (
  ...
  `member_sid` int(11) NOT NULL,
  PRIMARY KEY (`sid`)
) ENGINE=InnoDB AUTO_INCREMENT=7656 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `pd_rate` (
  `sid` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 資料表新增資料前，先清除舊資料 `pd_rate`
--

TRUNCATE TABLE `pd_rate`;
--
-- 傾印資料表的資料 `pd_rate`
--
...
CREATE TABLE IF NOT EXISTS `pd_time` (
  `sid` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 資料表新增資料前，先清除舊資料 `pd_time`
--

TRUNCATE TABLE `pd_time`;
--
-- 傾印資料表的資料 `pd_time`
--
