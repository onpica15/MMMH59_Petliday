...
<body>
  ...
  <header id="nav-bar">
    <nav class="navbar navbar-expand-lg navbar-light p-0">
      <div class="container">
        ...
        <div class="logo-search-m  nav-m d-flex">
          <a class="navbar-brand nav-m" href="<?= WEB_ROOT ?>index/index＿.php">
            <div class="logo">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 627.26 166.96">
                <defs>
                  <style>
        ...
        <div class="ham-box nav-m ">
          <div class="d-flex flex-column">
            <div class="ham-line 
            ham-line1 "></div>
            <div class="ham-line ham-line2"></div>
            <div class="ham-line ham-line3"></div>
          </div>
        </div>
        <div class="ham-items nav-item-m nav-m">
          <ul class="navbar-nav">
            ...
            <li class="nav-item ">
              <a class="nav-link item-m item-m-btm" href="<?= WEB_ROOT ?>userlogin/user-logout.php">登出</a>
            </li>
          </ul>
        </div>
          ...
          <li class="nav-item m-1 mr-3 only-m search-btn-m">
            <div class="nav-link ">
              <div class="navbtn nav-search-btn">
                <svg class="" id="search-btn" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 352.48 336.07" style="fill: #3c2e26;">
                  <g>
                    <path data-name="Path 144" d="M346.5,301.38l-84.25-83.79h0a142,142,0,1,0-26.4,31l82,81.51a20.3,20.3,0,1,0,28.72-28.71h0Zm-204.23-58a101,101,0,1,1,101-101,101,101,0,0,1-101,101Z" />
                  </g>
                </svg></button>
              </div>
              <div class="search-m only-m">
                <div class="search-line search-line1"></div>
                <div class="search-line search-line2"></div>
              </div>
  ...
  <script>
    ...
    $('.search-box').on('focus', function() {
      console.log('enter')
      $('.search-btn').addClass('svg#search-btn-focus');
    ...
    $('.search-btn-m').on('click', function() {
      $('.nav-search-btn svg').toggleClass('ing')
      $('.search-line').toggleClass('search-line-able')


      $('.navbar-brand').toggleClass('logo-unable')
      $('.search-box-m').toggleClass('search-box-able')
    ...
    $('.ham-box').on('click', function() {
      ...
      $('.ham-line2').toggleClass('ham-am2');
      $('.ham-line3').toggleClass('ham-am3');
