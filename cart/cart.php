...
<script>
  ...
  let manQuantity = document.getElementById('man-quantity')
  let petQuantity = document.getElementById('pet-quantity')
  let addButton = document.getElementById('add-icon')
  let subButton = document.getElementById('sub-icon')
  let addButton1 = document.getElementById('add-icon1')
  let subButton1 = document.getElementById('sub-icon1')
