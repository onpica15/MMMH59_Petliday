...
<div class="container mt-4 ">
  ...
  <div class="row prod-box d-flex align-items-center">
    ...
    <div class="col-10 col-lg-6 prod-text d-flex flex-column justify-content-center">
      <h5 class="brown-color t-l title1-m">標題標題標題標題標題標題標題標題題標題標題</h5>
    ...
    <div class="col-12 col-lg-3 change-box ">
      <div class="man-box all-box">
        ...
        <div class="change-man d-flex align-items-center">
          ...
          <div class="change-btn subtr-btn"><svg id="sub-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 34.84 5.1">
              <path data-name="Path 86" d="M32.23,0H2.61a2.55,2.55,0,1,0-.12,5.1H32.23A2.55,2.55,0,0,0,32.35,0Z" /></svg></div>
          <div class="change-quantity">1</div>
          <div class="change-btn add-btn"><svg id="add-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 34.84 34.73">
      ...
      <div class="pet-box all-box">
        ...
        <div class="change-man d-flex align-items-center">
          ...
          <div class="change-btn subtr-btn">
            <svg id="sub-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 34.84 5.1">
          ...
          <div class="change-btn add-btn">
            <svg id="add-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 34.84 34.73">
    ...
    <div class="col-12 col-lg-1 prod-price d-flex align-items-center ">
      <h5 class="t-m brown-color prod-price-in">NT$ 3000</h5>
    </div>
    <div class="del-icon">
...
<div class="container">
  <div class="row">
    <div class="col-12 total-box d-flex justify-content-end align-items-center p-3">
      ...
      <a href="#">
        <div class="buy-btn btn  btn-1 btn-2 d-flex align-items-center justify-content-center">結帳</div>
      </a>
